...
import MobileLecturerNavigation from "@/components/MobileLecturerNavigation";
...
const LecturerSidebar = () => {
  ...
  return (
    <>
      <aside className="hidden md:flex w-64 min-h-screen bg-sidebar text-sidebar-foreground flex-col shrink-0">
